...
public class MainActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] array = {"注册短信数据库变化的观察者", "收件箱数据库……", "删除新来电的通话记录", "监听新来电通话记录的详细信息", "取消注册Observer", "注册电话状态改变的广播，当有来电时立即挂断电话", "取消注册广播",};
    ...
    public void endCall() {
        ...
        try {
            ...
            //获取ServiceManager类的getService(String s)方法
            IBinder ibinder = (IBinder) method.invoke(null, Context.TELEPHONY_SERVICE);
            //参数为：调用此方法的对象，此方法的参数
            com.android.internal.telephony.ITelephony telephony = com.android.internal.telephony.ITelephony.Stub.asInterface(ibinder);
            //把上面getService(String s)得到的IBinder对象转化成【ITelephony】对象
            boolean isSuccess = telephony.endCall();
            //调用ITelephony挂断电话的方法
