...
public final class CHECKJVM {
    ...
    private static CHECKJVM mEmulatorDetector;


    private CHECKJVM(Context pContext) {
        mContext = pContext;
    ...
    public static CHECKJVM with(Context pContext) {
        if (pContext == null) {
            throw new IllegalArgumentException("Context 不能为空.");
        }
        if (mEmulatorDetector == null)
            mEmulatorDetector = new CHECKJVM(pContext.getApplicationContext());
        return mEmulatorDetector;
    }

    public CHECKJVM setCheckPackage(boolean chkPackage) {
        this.isCheckPackage = chkPackage;
        return this;
    }

    public CHECKJVM addPackageName(String pPackageName) {
        this.mListPackageName.add(pPackageName);
        return this;
    }

    public CHECKJVM addPackageName(List<String> pListPackageName) {
    ...
    public CHECKJVM setDebug(boolean isDebug) {
    ...
    public CHECKJVM setCheckQumeProps(boolean checkProps) {
    ...
    private boolean checkOperatorNameAndroid() {
        if (ContextCompat.checkSelfPermission(mContext, Manifest.permission.READ_PHONE_STATE)
                == PackageManager.PERMISSION_GRANTED && isSupportPhone()) {
